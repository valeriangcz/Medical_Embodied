## Robust Real-time LiDAR-inertial Initialization (ROS2 Humble)
...
```
cd ~/LI_Init_ws/src
git clone https://github.com/morte2025/LiDAR_IMU_Init_ROS2
cd ..
colcon build
source install/setup.bash
ros2 launch lidar_imu_init rs_airy.launch.py
```
...
cd ~/LI_Init_ws
source install/setup.bash
ros2 launch lidar_imu_init xxx.launch.py
```
