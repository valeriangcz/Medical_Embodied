...
[ROS Jazzy installation instructions](https://docs.ros.org/en/jazzy/Installation/Ubuntu-Install-Debs.html)
...
```shell
git clone https://github.com/HM-ZC/livox_ros_driver2_jazzy.git
```
